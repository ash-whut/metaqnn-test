...
#Train files
TRAIN_FILE = '/home/ashwin/datasets/cifar-10-batches-py/train.lmdb'                                                  # Path to training lmdb file -- YOU NEED TO CHANGE THIS
VAL_FILE = '/home/ashwin/datasets/cifar-10-batches-py/test.lmdb'                                                  # Path to validation lmdb file -- YOU NEED TO CHANGE THIS

CAFFE_ROOT = '/home/ashwin/anaconda3/envs/metaqnn/bin/caffe'                               # Path to caffe root directory -- YOU NEED TO CHANGE THIS

# For training caffe checkpoints
CHECKPOINT_DIR = 'trained_models_test/' + MODEL_NAME                                     # Path to where model snapshots are saved
